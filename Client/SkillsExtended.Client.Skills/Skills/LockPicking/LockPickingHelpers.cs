...
public static class LockPickingHelpers
{
    ...
    {
        { "factory4_day", LockPickingData.DoorPickLevels.Factory },
        { "factory4_night", LockPickingData.DoorPickLevels.Factory },
        { "Woods", LockPickingData.DoorPickLevels.Woods },
        { "bigmap", LockPickingData.DoorPickLevels.Customs },
        { "Interchange", LockPickingData.DoorPickLevels.Interchange },
        { "RezervBase", LockPickingData.DoorPickLevels.Reserve },
        { "Shoreline", LockPickingData.DoorPickLevels.Shoreline },
        { "laboratory", LockPickingData.DoorPickLevels.Labs },
        { "Lighthouse", LockPickingData.DoorPickLevels.Lighthouse },
        { "TarkovStreets", LockPickingData.DoorPickLevels.Streets },
        { "Sandbox", LockPickingData.DoorPickLevels.GroundZero },
        { "Sandbox_high", LockPickingData.DoorPickLevels.GroundZero },
        { "Labyrinth", LockPickingData.DoorPickLevels.Labyrinth },
    };
    ...
    public static void ApplyLockPickActionXp(
    ...
    )
    {
        ...
        var xpExists = SkillsExtendedPlugin.SkillData.LockPicking.XpTable.TryGetValue(
            doorLevel.ToString(),
            out var xp
        );
        var player = Singleton<GameWorld>.Instance.MainPlayer;
    ...
    private static void CompleteLockPickAction()
    {
        ...
        var player = Singleton<GameWorld>.Instance.MainPlayer;
        player.Skills.SkillsExtendedManager.LockPickAction.Complete(xpToApply);
    }

    public static void DisplayInspectInformation(
        WorldInteractiveObject interactiveObject,
        GamePlayerOwner owner
    )
    {
        ...
        NotificationManager.DisplayMessageNotification($"Lock level {doorLevel}");
    }
