    ...
    )
{
    ...
    private static SkillManager.Buff[] GetBuffs(SkillManager skillManager)
    {
        ...
        [
            ...
            skillManager.EnduranceBuffJumpCostRed.Max(
                Data.BuffJumpCostRedMax.NormalizeToPercentage()
            ),
            skillManager.EnduranceBuffBreathTimeInc.Max(
                Data.BuffBreathTimeIncMax.NormalizeToPercentage()
            ),
            skillManager
                .EnduranceBuffRestoration.Max(Data.BuffRestorationMax.NormalizeToPercentage())
